...
type TypedAgentConnectionSlice<T extends ProviderConfig> = Omit<AgentConnectionSlice, 'callLLM' | 'streamLLM' | 'callLLMStructured' | 'voiceLLM'> & {
...
export { type ProviderConfig as $, type StorylineSection as A, type BasicStateValue as B, type ChatResponse as C, type DefaultMessage as D, type ExecuteStateSetterParams as E, type TickerButton as F, type TickerMessage as G, type TodoListItem as H, type TodoListMessage as I, type TypedMessage as J, type MessageThread as K, type MessageThreadMap as L, type Message as M, DEFAULT_THREAD_ID as N, type StylingSlice as O, type CedarStore as P, type AISDKParams as Q, type AnthropicParams as R, type Setter as S, type TextMessage as T, type BaseParams as U, type CustomParams as V, type InferProviderParams as W, type InferProviderType as X, type LLMResponse as Y, type MastraParams as Z, type OpenAIParams as _, createAgentContextSlice as a, type MessagesSlice as a$, type StreamEvent as a0, type StreamHandler as a1, type StreamResponse as a2, type BaseStructuredResponseType as a3, type DefaultStructuredResponseType as a4, type CustomStructuredResponseType as a5, type StructuredResponseType as a6, type ResponseProcessor as a7, type ResponseProcessorRegistry as a8, type SendMessageParams as a9, type ChatInput as aA, type DebugLogEntry as aB, type SpellMap as aC, type SpellRegistration as aD, type StylingConfig as aE, createVoiceSlice as aF, type VoiceSlice as aG, type VoiceActions as aH, createSpellSlice as aI, type SpellState as aJ, type BaseSetter as aK, type DiffChecker as aL, type ProviderImplementation as aM, type InferProviderConfig as aN, type ResponseProcessorExecute as aO, type AISDKStructuredParams as aP, type VoiceParams as aQ, type VoiceLLMResponse as aR, isRegisteredState as aS, type AgentContextSlice as aT, type StylingState as aU, type StylingActions as aV, type MessageStorageBaseAdapter as aW, type LocalAdapterOptions as aX, createMessageStorageAdapter as aY, type MessageStorageState as aZ, getMessageStorageState as a_, BaseParamsSchema as aa, MastraParamsSchema as ab, CustomParamsSchema as ac, OpenAIParamsSchema as ad, AnthropicParamsSchema as ae, AISDKParamsSchema as af, LLMResponseSchema as ag, BaseStructuredResponseSchema as ah, StructuredResponseSchema as ai, StreamEventSchema as aj, VoiceLLMResponseSchema as ak, type MessageStorageConfig as al, type MessageThreadMeta as am, type MessageStorageCustomAdapter as an, type MessageStorageLocalAdapter as ao, type MessageStorageNoopAdapter as ap, type MessageStorageAdapter as aq, type VoiceState as ar, type SpellSlice as as, type DiffMode as at, type DiffState as au, type DiffHistoryState as av, type DiffHistorySlice as aw, type RegisterDiffStateConfig as ax, type ComputeStateFunction as ay, createDiffHistorySlice as az, createMessagesSlice as b, type AnyProviderParams as b0, type AgentConnectionSlice as b1, type TypedAgentConnectionSlice as b2, type DebuggerSlice as b3, createDebuggerSlice as b4, type StructuredParams as b5, type AISDKProviderConfig as b6, createAgentConnectionSlice as c, createStateSlice as d, createStylingSlice as e, type SetterFunction as f, type SetterArgs as g, type StateSlice as h, type ExecuteStateSetterOptions as i, type ExecuteCustomSetterParams as j, type ExecuteCustomSetterOptions as k, useSubscribeStateToAgentContext as l, type BaseMessage as m, type CustomMessage as n, type DialogueOptionChoice as o, type DialogueOptionsMessage as p, type MessageByType as q, type registeredState as r, type MessageInput as s, type MessageRenderer as t, useRenderAdditionalContext as u, type MessageRendererRegistry as v, type MessageRole as w, type MultipleChoiceMessage as x, type SliderMessage as y, type StorylineMessage as z };
