...
import { P as CedarStore, aA as ChatInput, aB as DebugLogEntry, U as BaseParams, Y as LLMResponse, av as DiffHistoryState, M as Message, s as MessageInput, aC as SpellMap, aD as SpellRegistration, aE as StylingConfig, ar as VoiceState } from '../index-DQQP-LkC.mjs';
export { m as BaseMessage, D as DefaultMessage, aw as DiffHistorySlice, at as DiffMode, au as DiffState, q as MessageByType, t as MessageRenderer, as as SpellSlice, aJ as SpellState, J as TypedMessage, aH as VoiceActions, aG as VoiceSlice, az as createDiffHistorySlice, aI as createSpellSlice, aF as createVoiceSlice } from '../index-DQQP-LkC.mjs';
...
declare const useDiffHistory: () => {
    diffHistoryStates: Record<string, DiffHistoryState<unknown>>;
