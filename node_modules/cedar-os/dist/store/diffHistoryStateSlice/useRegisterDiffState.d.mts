import { B as BasicStateValue, ax as RegisterDiffStateConfig, aL as DiffChecker } from '../../index-DQQP-LkC.mjs';
import 'zustand';
import 'zod';
 ...
 */
declare function addDiffToArrayObjs<T extends Record<string, unknown>>(oldState: T[], newState: T[], idField?: string, diffPath?: string, diffChecker?: DiffChecker): T[];
/**
